...
In the digital age, cyber attacks are inevitable. At , we are taking a
...
(a) 's security program and operations should be designed and
...
(b) Security shall remain a top priority in all aspects of 's business
...
### Security Architecture
 ...
 developed a security architecture on top of its three main
...
*  services deployed inside private subnets of Virtual Private Cloud (VPC)
...
1. Function
 ...
 strives to leverage functions as the primary building
