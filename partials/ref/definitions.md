...
* *Application*: An application hosted by , either maintained and
  created by , or maintained and created by a Customer or Partner.

* *Application Level*: Controls and security associated with an Application. In
  the case of PaaS Customers,  does not have access to and cannot assure
...
* *Disaster Recovery Service*: A disaster recovery service for disaster recovery
  ...
  an outage. Offered with all  Add-ons and as an option for PaaS
  Customers.
...
* *Customers*: Contractually bound users of  Platform and/or services.
...
* *Event*: An event is defined as an occurrence that does not constitute a
  serious adverse effect on , its operations, or its Customers, though
...
* *IDS Service*: An Intrusion Detection Service for providing IDS notification
  to customers in the case of suspicious activity. Offered with all 
  Add-ons and as an option for PaaS Customers.
...
* *PMP or Platform*:  Precision Medicine Platform and its overall
...
* *Risk Mitigation*: Referred to as Risk Management in the HIPAA Security Rule,
...
* *Security Incident* (or just Incident): A security incident is an occurrence
  ...
  * Unauthorized change or destruction of ePHI (i.e. delete dictation, data
    alterations not following 's procedures);
...
* *Vendors*: Persons from other organizations marketing or selling products or
