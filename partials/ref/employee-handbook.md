...
This is an abridged version of 's security policy that all
...
* First and foremost, as a Health IT provider,  and all
...
* You are also required to follow detailed procedures defined in certain
  policies related to your job role.
...
!!! check "Acknowledgement"
    ...
    As a  employee, I acknowledge that
    ...
    * I understand that PHI data may only be stored in approved production environments.
    * I understand company and regulatory requirements to protect critical data and will NOT

        * store critical data such as PHI and passwords on online file shares (such as Google Drive, SharePoint, Dropbox), in logs and source codes;
        * send critical data such as PHI and passwords by email, chat, or similar public communication channels;
        * post critical data such as PHI and passwords in blogs, support tickets or other public forums; and
        * discuss patient information in public.

    * I understand that use of paper records and fax transmission for PHI is not allowed.
...
* **Role-based security** training
    ...
    - all members of the **Development/Engineering** team must carefully review
      the following policies and procedures
        ...
        - [Product Security and Secure Software Development](sdlc.md), including
...
local on your laptop/workstation to the appropriate location on
 file sharing / team site (e.g. SharePoint). Examples of
...
!!! important
    ...
    DO NOT backup critical data such as ePHI or PII to file sharing sites.
...
* (preferred) “Report a security incident” by creating an issue on
   and/or via the
  [internal help desk](](mailto:security@)

* For non-sensitive, non-confidential security issues and concerns, employees
  may post questions on ’s #infosec Slack channel.
