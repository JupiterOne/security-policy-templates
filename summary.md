...
- **Assignment of Roles and the Security Committee**
  ...
  _It is required by regulatory compliance, such as HIPAA, to formally assign security and privacy responsibilities to someone in your organization. As your organization expands and matures, a security committee may be formed. Having an executive level security committee is often a requirement for security certifications such as HITRUST CSF. You can manage the role assignment manually (i.e. in this documented policy/control procedure), or manage role assignments to users/people in JupiterOne. In most cases, you do not need to implement a complicated enterprise GRC system._
